...
public class Student5DetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_student5_detail);

        Intent intent = getIntent();
        int studentId = intent.getIntExtra(EXTRA_STUDENTID, 1);
        Kid myStudent = Kid.period5Students[studentId];
